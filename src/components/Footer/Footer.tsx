    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ConKurrent explores ideas at the intersection of technology, culture, and future thinking. Join us as we navigate the complexities of our rapidly evolving world.
            </p>
          ...
          <div>
            ...
            <form className="space-y-2">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-purple-600 px-4 py-2 rounded-lg text-white font-medium hover:bg-purple-700 transition-colors"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>© {currentYear} ConKurrent Podcast. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
